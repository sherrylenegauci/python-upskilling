...
def get_leftover_of_bills(amount, denomination):
    ...
    bills_value = get_value_of_bills(denomination, number_of_bills)
    return amount - bills_value
...
def exchangeable_value(budget, exchange_rate, spread, denomination):
    ...
    new_rate = exchange_rate + exchange_fee
    total = exchange_money(budget, new_rate)
    number_of_bills = get_number_of_bills(total, denomination)
    new_max_value = get_value_of_bills(denomination, number_of_bills)
    
    return int (new_max_value)